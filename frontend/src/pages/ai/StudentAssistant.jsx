...
import { 
    FaRobot, FaMagic, FaPaperPlane, FaUserGraduate, 
                    ...
                    <div className={`flex-grow-1 overflow-y-auto p-4 d-flex flex-column gap-4 bg-ai-mesh custom-scrollbar ${
                        ...
                        {chatHistory.length === 0 && (
                            <div className="h-100 d-flex flex-column align-items-center justify-content-center text-center opacity-75">
                                <h2 className={`fw-bold mb-3 ${darkMode ? 'text-white' : 'text-primary'}`}>How can I help with your studies, {user?.username || 'Student'}?</h2>
                                <p className={`max-w-500 mb-5 ${darkMode ? 'text-white-50' : 'text-secondary'}`}>
                                    Ask me to explain a concept, help with an assignment, create a study plan, or test your knowledge.
                                </p>
                                
                                <div className="d-flex flex-wrap justify-content-center gap-3">
                                    {[
                                        { label: "Explain Data Structures", prompt: "Explain the concept of Data Structures and why they are important in programming." },
                                        { label: "Study Plan for Finals", prompt: "Help me create a 2-week study plan for my upcoming final exams." },
                                        { label: "Mock Quiz on Java", prompt: "Give me a quick mock quiz with 3 questions on Java inheritance." }
                                    ].map((suggest, i) => (
                                        <button 
                                            key={i} 
