                ...
                >
                    ...
                    <div className="p-4 bg-ai-gradient d-flex align-items-center justify-content-between text-white">
                        <div className="d-flex align-items-center gap-3">
                            ...
                            <div>
                                <h5 className="fw-bold mb-0">CurveIQ Neural Assistant</h5>
                    ...
                    <div className={`p-4 border-top ${
                        ...
                        <p className="text-center text-xs text-muted mt-3 mb-0 opacity-50">
                            CurveIQ AI may provide inaccurate info about people, places, or facts. Verify important curriculum data.
                        </p>
                    </div>
                </motion.div>
            </div>
