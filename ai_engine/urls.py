...
urlpatterns = [
    ...
    path('generate-quiz/', views.GenerateQuizFromPromptView.as_view(), name='generate_quiz_from_prompt'),
    path('lesson-plan/', views.GenerateLessonPlanView.as_view(), name='generate_lesson_plan'),
